<header>
  <nav class="columns is-multiline" role="navigation">
    ...
    <div id="header-profiles" class="buttons is-2 is-hidden-mobile">
      <a href="#" class="has-text-grey-dark"><span class="fab fa-facebook fa-fw fa-2x"></span></a>
      <a href="#" class="has-text-grey-dark"><span class="fab fa-instagram fa-fw fa-2x"></span></a>
    </div>
